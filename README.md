...
The expected time complexity of Pollard's Rho algorithm for elliptic curves is <code>O(&#8730;n)</code>, where <code>n</code> is the order of the group generated by the elliptic curve points. Given secp256k1, this translates to approximately <code>O(2<sup>128</sup>)</code> operations in the worst-case scenario.
